...
//------------------------------------------------------------------------------
	...
	this.getFileForURL = function(URL) {
		...
		Ti.API.info("Speaker images exists in images/: " + imagesFileExists);
		if (imagesFileExists == true) {
			return imagesFile.nativePath;
		}
		...
		Ti.API.info("Speaker images exists in data dir: " + dataDirFileExists);
		if (dataDirFileExists == true) {
			return dataDirFile.nativePath;
		}		
